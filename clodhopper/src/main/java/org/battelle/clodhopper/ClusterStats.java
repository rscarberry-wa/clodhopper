...
/**
 * Contains statistical calculation methods relating to clustering.
 * Since all methods are static, this class is uninstantiable.
 * 
 * @author R. Scarberry
 * @since 1.0
 *
...
public final class ClusterStats {
	...
	/**
	 * Computes the mean and variance of the data from a subset of tuples represented
	 * by a cluster. 
	 * 
	 ...
	 * 
	 * @return a 2D array of dimensions [tupleLen][2], where tupleLen is the length of the tuples.
	 *   For a given index n in [0 - (tupleLen-1)], element 0 is the mean, element 1 is the variance.
	 */

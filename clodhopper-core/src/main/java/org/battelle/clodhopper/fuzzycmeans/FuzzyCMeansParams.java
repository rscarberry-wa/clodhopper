...
public class FuzzyCMeansParams {
     ...
     *
     * @return the number of clusters requested.
     */
     ...
     * regardless of whether or not the error level is less than the epsilon
     * value.
     *
    ...
    /**
     * Get the fuzziness level, a value of at least 1, which is used in
     * computing interim cluster centers and the error level.
     *
     * @return the fuzziness measure.
     */
     ...
     *
     * @param fuzziness the fuzziness level.
     *
     * @throws IllegalArgumentException if less than 1.0
     */
    public void setFuzziness(final double fuzziness) {
        if (fuzziness < 1.0) {
    ...
    /**
     * Get the epsilon value. When the computed error level is less than this
     * value, clustering terminates.
     *
     ...
     *
     * @return the number of worker threads to use for concurrent subtasks.
     */
     ...
     *
     * @param n the number of worker threads to use.
     *
     ...
     *
     * @param distanceMetric a <code>DistanceMetric</code> instance.
     *
     ...
     *
     * @param seeder an instance of <code>ClusterSeeder</code>.
     *
     * @throws NullPointerException if null
     */
    ...
    /**
     * A builder class used for convenience in creating a FuzzyCMeansParams
     * object. Each method returns a reference to the builder, so calls can be
     * chained.
     *
     * @author R. Scarberry
     * @since 1.0
